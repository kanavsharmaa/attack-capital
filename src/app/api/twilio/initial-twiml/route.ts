...
export async function POST(req: NextRequest) {
  ...
  if (answeredBy === "human") {
    ...
    response.say("Hello, we hae verified you to be a human. Please wait while we connect you to our agent.");
    ...
    console.log(
      `AMD failed, timed out, or not human/machine. Hanging up. AMD status: ${answeredBy}`
    );
    response.hangup();
  }
